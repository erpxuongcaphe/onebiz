...
| Bảng giá | Resolver, quyền, audit và giá nền tảng theo variant đã có trong code; UI phạm vi nhiều chi nhánh và ma trận giá theo size đã triển khai trên nhánh | Chạy preflight rồi migration 00363/00364, UAT lịch không thời hạn/có thời hạn, overlap và quyền trước merge | P0-P1 |
| Giá thành phần tại quán | UI và resolver BOM đã chuyển sang giá bán Retail trong 00363 | Chạy migration, đối chiếu giá vốn Hồng Trà/Xưởng Gu Việt và snapshot báo cáo hợp nhất | P0 |
| POS F&B giá/size | POS đã phân giải platform variant -> platform món -> tier variant -> tier món -> giá niêm yết | Chạy migration và UAT server/POS tại Xưởng Tư Búa, gồm đổi size và nguồn đơn | P0 |
