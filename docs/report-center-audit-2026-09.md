...
- Bảng doanh thu theo bàn F&B: kỳ lọc nay dùng ngày chứng từ hóa đơn như KPI và bảng theo giờ, thay vì ngày tạo đơn bếp; lọc cùng nguồn F&B và bỏ hóa đơn hủy, vẫn đếm một lần khi gửi bếp nhiều lượt. Đây chỉ là doanh thu của hóa đơn gắn bàn có đơn bếp hoàn tất, không bao gồm mang về/giao hàng và chưa phải doanh thu ròng sau trả hàng.
...
1. **Đối soát số liệu nguồn (P0, đang làm):** KPI, bảng theo giờ và bảng theo bàn đã thống nhất mốc ngày hóa đơn; còn phải đối soát bằng chứng từ thật cùng kỳ/chi nhánh, xác định hoàn tiền/phiếu trả, hóa đơn sửa/hủy và phần doanh thu không gắn bàn. Không kết luận đủ quản trị trước bước này.
