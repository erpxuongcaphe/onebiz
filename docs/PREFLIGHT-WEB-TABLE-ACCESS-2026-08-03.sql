...
with required(relation_name, operation) as (
  values
    ...
    ('disposal_exports', 'insert'),
    ('disposal_exports', 'select'),
    ('favorites', 'select'),
    ('floor_plan_decorations', 'delete'),
    ('floor_plan_decorations', 'insert'),
    ('floor_plan_decorations', 'select'),
    ('floor_plan_decorations', 'update'),
    ('floor_plan_zones', 'insert'),
    ('floor_plan_zones', 'select'),
    ('floor_plan_zones', 'update'),
    ('floor-plans', 'select'),
    ...
    ('internal_sales', 'insert'),
    ('internal_sales', 'select'),
    ('inventory_check_items', 'select'),
    ('inventory_checks', 'insert'),
    ('inventory_checks', 'select'),
    ('invoice_items', 'select'),
    ('invoices', 'select'),
    ('kitchen_order_items', 'delete'),
    ('kitchen_order_items', 'insert'),
    ('kitchen_order_items', 'select'),
    ('kitchen_order_items', 'update'),
    ('kitchen_orders', 'insert'),
