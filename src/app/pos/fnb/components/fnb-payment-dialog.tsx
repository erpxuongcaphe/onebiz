              ...
              <div className="flex flex-wrap gap-2 sm:gap-1.5">
                ...
                {DENOMINATIONS.map((d) => (
                  <button key={d} type="button"
                    ...
                    className="px-3 py-2 sm:px-2.5 sm:py-1.5 rounded-md border border-gray-200 bg-white text-sm sm:text-xs font-medium text-gray-700 hover:bg-gray-100 active:bg-gray-200 transition-colors tabular-nums">
                    {formatDenom(d)}
                  </button>
                ))}
              </div>
