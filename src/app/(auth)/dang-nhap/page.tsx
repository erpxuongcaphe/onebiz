...
const OPERATION_AREAS = [
  { icon: "inventory_2", label: "Inventory", value: "Stock" },
  { icon: "point_of_sale", label: "Retail POS", value: "Sales" },
  { icon: "restaurant", label: "FnB POS", value: "Service" },
  { icon: "analytics", label: "Reports", value: "Insights" },
];
    ...
    <main className="relative isolate flex min-h-dvh overflow-hidden bg-background">
      ...
      <section className="mx-auto grid min-h-dvh w-full min-w-0 max-w-7xl grid-cols-1 lg:grid-cols-[minmax(0,1fr)_480px]">
        <div className="hidden min-h-dvh flex-col justify-between px-10 py-8 lg:flex xl:px-14">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-4 max-w-lg text-base leading-7 text-muted-foreground">
              Sales, inventory, FnB and reports in one place.
            </p>
        ...
        <div className="flex min-h-dvh w-full min-w-0 items-center justify-start px-4 py-8 sm:justify-center sm:px-6 lg:px-8">
          <section className="mx-auto w-[calc(100vw-2rem)] max-w-[300px] rounded-lg border border-white/70 bg-card/95 p-5 shadow-[0_24px_80px_rgba(15,23,42,0.14)] backdrop-blur sm:w-full sm:max-w-[420px] md:p-7">
