...
export default function XuatNhapTonPage() {
  ...
  const detailColumns: DataTableColumn<XntRow>[] = [
    ...
    // NHẬP × 5
    { label: "NCC", key: "inSupplier", align: "right", cell: (r) => formatNumber(r.inSupplier) },
    { label: "Kiểm(+)", key: "inCheck", align: "right", cell: (r) => formatNumber(r.inCheck) },
    { label: "Trả KH", key: "inReturn", align: "right", cell: (r) => formatNumber(r.inReturn) },
    { label: "Chuyển đến", key: "inTransfer", align: "right", cell: (r) => formatNumber(r.inTransfer) },
    { label: "SX nhập", key: "inProduction", align: "right", cell: (r) => formatNumber(r.inProduction) },
    // XUẤT × 6
    { label: "Bán", key: "outSale", align: "right", cell: (r) => formatNumber(r.outSale) },
    { label: "Hủy", key: "outDisposal", align: "right", cell: (r) => formatNumber(r.outDisposal) },
    { label: "Trả NCC", key: "outSupplierReturn", align: "right", cell: (r) => formatNumber(r.outSupplierReturn) },
    { label: "Kiểm(-)", key: "outCheck", align: "right", cell: (r) => formatNumber(r.outCheck) },
    { label: "Chuyển đi", key: "outTransfer", align: "right", cell: (r) => formatNumber(r.outTransfer) },
    { label: "SX xuất", key: "outProduction", align: "right", cell: (r) => formatNumber(r.outProduction) },
    {
      label: "Tồn cuối",
      key: "closingQty",
      align: "right",
