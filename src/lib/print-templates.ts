 ...
 * CEO 20/08: ghi RÕ "Số lượng", không viết tắt "SL" trên chứng từ in.
 */
const SALE_ITEM_COLUMNS = ["Mã hàng", "Tên hàng", "Số lượng", "Đơn giá", "Thành tiền"];
...
const PURCHASE_ITEM_COLUMNS = ["Mã hàng", "Tên hàng", "Số lượng", "Đơn giá nhập", "Thành tiền"];
