...
export const config = {
  matcher: [
     ...
     * - manifest files, sw.js, workbox-*, PWA assets
     *
     ...
     */
    "/((?!_next/static|_next/image|api/|favicon\\.ico|sitemap\\.xml|robots\\.txt|manifest(?:-[^/]+)?\\.(?:json|webmanifest)|offline\\.html|sw\\.js|workbox-.*|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff|woff2|css|js)$).*)",
  ],
};
