-- 00349: Let operators retire a legacy-invalid option without first making a
-- synthetic edit. Active options remain fully guarded by 00347.
...
declare
  ...
  v_tenant_id uuid;
begin
  -- Keep default writes serialized per group, including a retirement action.
  ...
  -- A soft-deleted option is never emitted to POS. Allow retirement of
  -- legacy-invalid records; re-activating the same record runs every guard.
