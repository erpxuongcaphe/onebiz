-- ============================================================================
-- 00337 HOÀN TÁC — khôi phục nguyên văn bản 00333.
--
-- ⚠️ HOÀN TÁC NÀY MỞ LẠI LỖ HỔNG: gắn được đơn con còn NHÁP, ĐÃ HUỶ hoặc ĐÃ
-- VOID vào đơn đặt hàng, khiến đơn gốc rời danh sách chờ POS trong khi chưa
-- thu tiền. Chỉ chạy khi bản 00337 gây sự cố thật và cần khôi phục dịch vụ.
--
-- Nội dung dưới đây là BẢN 00333 nguyên văn (create or replace cùng chữ ký).
-- ============================================================================
