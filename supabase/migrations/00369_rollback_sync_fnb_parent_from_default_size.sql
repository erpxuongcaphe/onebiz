...
do $restore_00368$
begin
  if to_regprocedure('public.save_fnb_size_setup_atomic_00368(uuid,jsonb)') is not null then
    alter function public.save_fnb_size_setup_atomic_00368(uuid, jsonb)
