-- ============================================================
-- FIX: seed_tenant_foundation — sửa lỗi "aggregate functions
-- are not allowed in RETURNING"
-- Database có phiên bản cũ dùng RETURNING array_agg(...)
-- Phiên bản đúng dùng SELECT array(SELECT id FROM ...)
-- ============================================================
...
-- ============================================================
-- FIX: handle_new_user — phiên bản mới nhất (gọi cả 2 seed)
-- ============================================================
