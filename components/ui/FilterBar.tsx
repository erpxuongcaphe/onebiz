    ...
    return (
        <div className="flex flex-wrap items-center gap-2">
                ...
                <div key={filter.key} className="relative">
                    ...
                    {openDropdown === filter.key && (
                        <>
                            ...
                            />
                            <div className="absolute left-0 top-full mt-1 z-50 w-48 p-1 bg-white border border-slate-200 rounded-xl shadow-lg max-h-64 overflow-y-auto">
                                <button
                                    onClick={() => {
                                        onChange(filter.key, '');
            ...
            {activeFilters.length > 0 && onReset && (
                <button
                    onClick={onReset}
                    className="inline-flex items-center gap-1 px-2 py-1 text-xs text-slate-500 hover:text-slate-700 transition-all"
                >
