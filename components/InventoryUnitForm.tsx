...
const InventoryUnitForm: React.FC<Props> = ({ title, initial, busy, error, submitLabel, onSubmit }) => {
    ...
    return (
        <div className="space-y-3">
            ...
            <label className="block">
                <div className="text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1">Mã (Viết tắt)</div>
                <input
                    value={code}
